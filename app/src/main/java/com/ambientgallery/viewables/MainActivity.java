        ...
        textMain.setOnHoverListener((v, event) -> {
            switch (event.getAction()) {
                case MotionEvent.ACTION_HOVER_ENTER:
                    viewColor(0xFFFFFFFF, 0xFFFF0000, 1, 1, prefsInt(prefs, ANIMATION_DURATION_SHORT), new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                ...
                case MotionEvent.ACTION_HOVER_EXIT:
                    viewColor(0xFFFF0000, 0xFFFFFFFF, 1, 1, prefsInt(prefs, ANIMATION_DURATION_SHORT), new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public void onAnimationUpdate(@NonNull ValueAnimator animation) {
                            textMain.setTextColor((int) animation.getAnimatedValue());
                        }
