...
public class SettingsAppearanceAmbientCardFragment extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_settings_appearance_ambient_card, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            ImageView imageView = getActivity().
                    findViewById(R.id.settings_appearance_ambient_card_image);
            imageView.setAlpha(prefsFloat(prefs, "bgAmbientOpacity"));
